...
import { rlParameterOptimizer } from '@/services/rlParameterOptimizer';
import { tradePatternAnalyzer } from '@/services/tradePatternAnalyzer';
...
class SystemAuditor {
  ...
  async runFullAudit(): Promise<AuditResult[]> {
    logger.info('🔍 Starting comprehensive system audit...', { context: 'SystemAudit' });
    ...
    logger.info('✅ System audit complete', {
      context: 'SystemAudit',
      data: {
  ...
  private async auditDatabase() {
    logger.info('💾 Auditing database...', { context: 'SystemAudit' });
  ...
  private async auditServices() {
    logger.info('⚙️ Auditing services...', { context: 'SystemAudit' });
  ...
  private async auditTradingParameters() {
    logger.info('📊 Auditing trading parameters...', { context: 'SystemAudit' });
  ...
  private async auditSafetyChecks() {
    logger.info('🛡️ Auditing safety checks...', { context: 'SystemAudit' });

...
import { rlParameterOptimizer, ParameterState, TradingParameters } from '@/services/ml/rlParameterOptimizer';
...
export class DynamicConfigService {
  ...
  private async updateConfig(): Promise<void> {
    try {
      logger.info('[UPDATE] Updating dynamic configuration based on RL optimization', {
      ...
      logger.info('[OK] Dynamic configuration updated', {
        context: 'DynamicConfigService',
        data: {
  ...
  async applyConfig(): Promise<void> {
    ...
    logger.info('[CONFIG] Applying dynamic configuration', {
      context: 'DynamicConfigService',
      data: {
        confidenceThreshold: config.confidenceThreshold,
